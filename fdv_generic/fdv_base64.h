...
namespace fdv
{
  ...
  struct Base64
  {
    ...
    ////////////////////////////////////////////////////////////////////////////////
    // calcLength
    static int16_t calcLength(char const* str, bool strict = false)
    {
      int16_t l = 0;
      uint8_t term = 0;
      for (;;)
    ...
    ////////////////////////////////////////////////////////////////////////////////
    // decode
    static int16_t decode(void* dest, char const* b64str, bool strict = false)
    {
      uint8_t buffer[4];
      uint8_t idx = 0;
      uint8_t term = 0;
...
finalize:
    ...
    ////////////////////////////////////////////////////////////////////////////////
    // encode
    static void encode(char* dest, void const* src, uint16_t length)
    {
      uint16_t i, j;
      uint8_t a[4];
  ...
  private:
    ...
    static char bit6toAscii(uint8_t a)
    {
      a &= (uint8_t) 0x3F;
